...
<!--
  ...
  https://facebook.github.io/create-inferno-app/docs/troubleshooting

  Please scan these few sections for common problems.
  Additionally, you can search the User Guide itself for something you're having issues with:

  https://facebook.github.io/create-inferno-app/
...
<!--
  ...
  Run the following command in your Inferno app's folder in terminal.
  Note: The result is copied to your clipboard directly.

  `npx create-inferno-app --info`
