...
This package includes some utilities used by [Create Inferno App](https://github.com/facebook/create-inferno-app).<br>
...
getCacheIdentifier('prod', ['inferno-dev-utils', 'chalk']); // # => 'prod:inferno-dev-utils@5.0.0:chalk@3.0.0'
```
