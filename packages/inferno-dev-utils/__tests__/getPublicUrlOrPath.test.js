...
const tests = [
  ...
  { dev: true, homepage: 'https://create-inferno-app.dev/', expect: '/' },
  {
    dev: true,
    homepage: 'https://create-inferno-app.dev/test',
    expect: '/test/',
  },
  ...
  { dev: true, publicUrl: 'https://create-inferno-app.dev/', expect: '/' },
  {
    dev: true,
    publicUrl: 'https://create-inferno-app.dev/test',
    expect: '/test/',
  },
  ...
  {
    dev: true,
    publicUrl: 'https://create-inferno-app.dev/',
    homepage: '/test',
    expect: '/',
  },
  {
  ...
  { dev: false, homepage: 'https://create-inferno-app.dev/', expect: '/' },
  {
    dev: false,
    homepage: 'https://create-inferno-app.dev/test',
    expect: '/test/',
  ...
  { dev: false, publicUrl: './test/path', expect: './test/path/' },
  {
    dev: false,
    publicUrl: 'https://create-inferno-app.dev/',
    expect: 'https://create-inferno-app.dev/',
  },
  {
    dev: false,
    publicUrl: 'https://create-inferno-app.dev/test',
    expect: 'https://create-inferno-app.dev/test/',
  },
