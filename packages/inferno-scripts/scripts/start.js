...
const inferno = require(require.resolve('inferno', { paths: [paths.appPath] }));
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    devServer.startCallback(() => {
      ...
      if (env.raw.FAST_REFRESH && semver.lt(inferno.version, '16.10.0')) {
        console.log(
          chalk.yellow(
            `Fast Refresh requires Inferno 16.10 or higher. You are using Inferno ${inferno.version}.`
          )
        );
      }
