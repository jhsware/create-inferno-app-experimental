...
module.exports = function (
  ...
  // Install inferno and inferno-dom for backward compatibility with old CRA cli
  // which doesn't install inferno and inferno-dom along with inferno-scripts
  if (!isInfernoInstalled(appPackage)) {
    args = args.concat(['inferno', 'inferno-dom']);
  }

  // Install template dependencies, and inferno and inferno-dom if missing.
...
function isInfernoInstalled(appPackage) {
  ...
  return (
    ...
    typeof dependencies['inferno-dom'] !== 'undefined'
  );
}
