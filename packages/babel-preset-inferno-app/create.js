...
module.exports = function (api, opts, env) {
  ...
  return {
    ...
    plugins: [
      ...
      // Related: https://github.com/facebook/create-inferno-app/pull/8215
      // [
      //   require('@babel/plugin-transform-destructuring').default,
      //   {
      //     // Use loose mode for performance:
      //     // https://github.com/facebook/create-inferno-app/issues/5602
      //     loose: false,
      //     selectiveLoose: [
      //       'useState',
      //       'useEffect',
      ...
      // See discussion in https://github.com/facebook/create-inferno-app/issues/4263
      // Note:
      ...
      // See https://github.com/facebook/create-inferno-app/issues/8445#issuecomment-588512250
