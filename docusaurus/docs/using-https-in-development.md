...
```json
{
  "start": "HTTPS=true inferno-scripts start"
}
```

Or you can create a `.env` file with `HTTPS=true` set.
[Learn more about environment variables in CRA](https://create-inferno-app.dev/docs/adding-custom-environment-variables).
