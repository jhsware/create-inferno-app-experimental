...
By default, Create Inferno App includes a performance relayer that allows you to measure and analyze
...
experience of a web page. In Create Inferno App, a third-party library is used to measure these
